...
$PARAM  // Population parameters
  TVKA = 3.95,  // absorption rate constant, for caffeine gum (h-1)
  ...
  F1 = 0.77,  // bioavailability of caffeine gum (dimensionless)
...
$ODE  // Differential Equations
  ...
  dxdt_GUT = -KA*GUT;
  dxdt_CENT = F1*KA*GUT - CENT*K12 + PERI*K21 - C1*CLCAPX - C1*CLCAO;
