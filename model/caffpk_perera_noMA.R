...
# ------------------------------------------------------------------------------
# Parameters taken from no methylxanthine abstinence model
#
# Model sourced from:
...
$INIT  // Initial Conditions for Compartments (mg)
  GUT = 1.18,  // Absorption Compartment // IC(4) - 1.18 FIXED
  CENT = 3.40,  // Central Compartment // IC(1) - 3.40 (187 CV%)
  PERI = 1.21,  // Peripheral Compartment // IC(2) - 1.21 FIXED
  PARA = 6.93,  // Paraxanthine Compartment // IC(3) - 6.93 (103 CV%)
...
$PARAM  // Population parameters
  TVKA = 3.55,  // absorption rate constant (h-1)
  TVK12 = 1.54,  // microconstant - cent-peri (h-1)
  TVK21 = 2.40,  // microconstant - peri-cent (h-1)
  TVV1 = 27.7,  // central volume of distribution (L)
  TVV2 = 18.4,  // peripheral volume of distribution (L)
  TVTLAG = 0.14,  // lag-time (h) {says h-1 in manuscript?}
  TVCLCAPX = 2.63,  // clearance of caffeine - to paraxanthine (L/h)
  TVCLCAO = 3.70,  // clearance of caffeine - renal and other (L/h)
  TVCLPX = 3.74,  // clearance of paraxanthine (L/h)
