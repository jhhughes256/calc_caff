# Caffine PopPK Model Simulation - Regimen using Caffeine gum PK
# ------------------------------------------------------------------------------
...
# Source external scripts
  ...
  source("model/caffpk_perera_gum.R")  # PopPK model script
...
# Source population and empty central and peripheral compartments
  source("scripts/190628_Population_Perera.R")
  pop_tb <- dplyr::mutate(pop_tb, CENT_0 = 0, PARA_0 = 0, GUT_0 = 0, PERI_0 = 0)
